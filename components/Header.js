...
export function Header() {
  return (
    <div className="max-w-6xl mx-auto p-[16px] flex justify-between">
      ...
      <div className="flex gap-[24px] items-center">
        ...
        <div className=" hidden lg:block items-center w-[136px] h-[36px] rounded-[12px] px-[16px] py-[6px] bg-slate-950 text-white">
          <p>Download CV</p>
        </div>
      </div>
    </div>
